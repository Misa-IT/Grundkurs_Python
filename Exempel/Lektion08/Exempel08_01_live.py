...
# Vi skapar en Klass genom at använda oss av detta mönster:
...
# En intentering på varje rad som tillhör klassen.
...
# Om vi vill skapa en Instant av Klassen skriver vi så här:
my_instance = MyClass()

# Om vi vill komm åt t.ex. listan som ligger i Klassen så gör vi så här:
print("Listan i Klassen:", MyClass.my_list)

# Notera att vi kommer åt listan även från vår nyskapade Instans/ vårt Objekt.
