...
# Namnet på Funktionen. Bör vara lätt att förstå och bör inte innehålla
#   åäö. Namnet bör också vara i små bokstäver med understreck (_)
...
def exempelfunktion():
    print("Vår Funktion gör inget för stunden så jag lägger in lite text "
          "så länge.")


# När vi vill köra vår Funktion, även kallat för att "anropa" eller "kalla"
#   på den, så måste vi använda parenteser, (), efter namnet för att
#   meddela att vi faktiskt vill köra Funktionen.
exempelfunktion()


# Om vi vill skapa en Funktion som ska kunna ta emot instruktioner om vad
#   den ska arbeta med så måste vi skriva in det mellan parenteserna när vi
...
def funktion_som_tar_emot_tre_argument(godtyckligt_namn1,
                                       godtyckligt_namn2,
                                       godtyckligt_namn3=8,
                                       ):
...
funktion_som_tar_emot_tre_argument(4.567, godtyckligt_namn3=5,
                                   godtyckligt_namn2="HEJ")
